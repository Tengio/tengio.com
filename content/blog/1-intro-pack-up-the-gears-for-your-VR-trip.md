...
description = "Introduction and steps to configure Unity for Cardboard development."
author = "quentin"
...
![article-img-centered](/img/blog/0006/1_0_unity_install_components_selection.jpg "Unity install")
...
![article-img](/img/blog/0006/1_1_unity_GoogleVR_demoScene_layout_default.jpg "Default layout")
...
![article-img](/img/blog/0006/1_2_unity_GoogleVR_demoScene_layout_2by3.jpg "2 by 3 layout")

Congratulation! Your first VR app is ready to run! Now follow Google's instructions to build it to your device. Once this is done the app should start automatically, place the device in your Cardboard and look around. This is VR!
